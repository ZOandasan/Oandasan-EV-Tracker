export default function AboutEVTracker() {
    return (
      <div>
        <h1 className="head">About The EV Tracker</h1>
        <div className="para">
          ...
          <h3 className="head">How do you get EVs?</h3>
        <div className="para">
          ...
          <h3 className="head">How do I know which stats will make my pokemon the strongest?</h3>
        <div className="para">
